...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--output_graph',
      type=str,
      default='./train_result/output_graph.pb',
      help='Where to save the trained graph.'
  )
  parser.add_argument(
      '--intermediate_output_graphs_dir',
      type=str,
      default='./train_result/intermediate_graph/',
  ...
  parser.add_argument(
      '--output_labels',
      type=str,
      default='./train_result/output_labels.txt',
      help='Where to save the trained graph\'s labels.'
  )
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='./train_result/retrain_logs',
  ...
  parser.add_argument(
      ...
      default="./train_result/misclassified.txt",
      help="""\
  ...
  parser.add_argument(
      '--model_dir',
      type=str,
      default='./mobilenet/mobilenet_1.0_160/',
      help="""\
  ...
  parser.add_argument(
      '--bottleneck_dir',
      type=str,
      default='./train_result/bottleneck',
